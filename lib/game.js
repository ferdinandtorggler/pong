module.exports = function (io) {
    ...
    return function (room) {
        ...
        var setHandle = function (player, y) {
            ...
            sendHandlePositions(player1, player2);
        };

        var sendHandlePositions = function (player1, player2) {
            io.sockets.in(room).emit('handle positions', {player1: player1.y, player2: player2.y});
        };


        /*
         *  COLLISION DETECTION FUNCTIONS FOR GAME LOOP
         */
